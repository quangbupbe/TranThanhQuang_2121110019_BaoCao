<div class="row ">
    ...
    <div class="col-6 my-4 px-4">
        <form action="{{ route('site.register') }}" method="post">
            ...
            <input type="text" name="email" id="email" class="form-control" placeholder="abc123@gmail.com"
                value="{{ old('email') }}">
            @if ($errors->has('email'))
                <div style="  font-size: small;
                " class="text-danger">
            ...
            <p style="font-size: small" class="text-success">Nếu email đã tồn tại , xin vui lòng đăng nhập để kích hoạt
                tài khoản và sau đó <a href="{{ route('site.forget_password') }}"> đặt lại mật khẩu </a>nếu bạn quên.
            </p>
