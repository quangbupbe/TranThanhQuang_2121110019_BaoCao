    ...
    <div class="container myaccount">
        ...
        <div class="row">
            <div class="col-3 left-content">
                ...
                <ul>
                    <li>
                        <a style="color:#333" href="{{ route('site.myaccount') }}">trang tài khoản <i
            ...
            <div class="col-9 right-content">
                <div class="m-3">
                    <p> Xin chào <span style="font-weight: bold">{{ $user->name }} </span>(không phải tài khoản <span
                            style="font-weight: bold">{{ $user->name }} </span>? Hãy <a
                            title="Bấm vào để đăng xuất ngay lập tức" href="{{ route('site.logout') }}">thoát ra</a> và
                        đăng nhập vào tài khoản của bạn)</p>
                    <p>Từ trang quản lý tài khoản bạn có thể xem <a href="{{ route('account.order') }}"> đơn hàng mới</a>,
                        quản lý <a href="{{ route('account.address') }}"> địa chỉ giao hàng và thanh toán</a>, <a
                            href="{{ route('account.edit') }}"> sửa mật khẩu và thông tin tài khoản</a>.</p>
                </div>
