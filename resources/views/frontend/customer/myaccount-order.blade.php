        ...
        <div class="row">
            <div class="col-3 left-content">
                ...
                <ul>
                    ...
                    <li>
                        <a style="color:#333" href="{{ route('account.order') }}">đơn hàng <i
                        ...
                        <tbody>
                            @foreach ($order as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('site.ordercomplete', ['code' => $item->code]) }}"
                                            class='text-{{ $list_status[$item->status]['type'] }}'>
                                            {{ $list_status[$item->status]['text'] }}
                                        </a>
                                    </td>
                                    <td><span class="fw-bold">{{ number_format($item->a_total_price) }} VND</span> cho
                                        {{ $item->a_total_qty }} mục</td>
