        ...
        <div class="header-wrapper   ">
            ...
            <div class="navbar  " id="navbar">
                <div class="header-main  d-md-block d-none container ">
                    <div class="header-inner  d-flex  justify-content-between align-items-center">
                        <div class="logo mr-5 ">
                            <img src="{{ asset('images/logo3.jpg') }}" alt="logo.jpg" style="width: 100px">
                        </div>
                            ...
                            <ul class="d-flex align-items-center m-0 heart-far">
                                @if (Auth::guard('users')->check())
                                    <li class="infor-item heart-icon-box heart-far">
                                        ...
                                        <ul class="heart-sub">
                                            <li class="text-center text-decoration-underline fw-light">
            ...
            <div class="menu-wrapper" id="menu-wrapper">
                <div class="header-main  d-md-block d-none">
                    <div class="header-inner d-flex  justify-content-between align-items-center">
                        <div class="logo ">
                            <img src="{{ asset('images/logo.jpg') }}" alt="logo.jpg">
                        </div>
