...
class SiteCheckoutController extends Controller
{
        ...
        try {
            Mail::send(
                ...
                function ($send_email) use ($user) {
                    $send_email->subject('Shop Cake by Q - Xác nhận đơn hàng');
    ...
    public function momo_payment(Request $request)
    {
        ...
        $orderId = time() . "";
        $redirectUrl = "http://localhost/tranthanhquang_lavarel/public/thanh-toan-thanh-cong/" . $request->code;
        $ipnUrl = "http://localhost/tranthanhquang_lavarel/public/thanh-toan-thanh-cong/" . $request->code;
        $extraData = "";
    ...
    public function vnpay_payment(Request $request)
    {
        ...
        $vnp_Returnurl = "http://localhost/tranthanhquang_lavarel/public/thanh-toan-thanh-cong/" . $request->code;
